        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionSubtitle}>
              Mostre para a irmandade o que você deseja doar!
            </Text>
            ...
            >
              <View
                style={[
                  ...
                  isUrgent && styles.urgencyToggleActive,
                ]}
              >
                <MaterialIcons
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.urgencySublabel}>
                  Marque se o item precisa ser coletado o quanto antes.
                </Text>
              </View>
              <View
                style={[
                  styles.switchTrack,
                  isUrgent && styles.switchTrackActive,
                ]}
              >
                <View
                  style={[
          ...
          <View style={styles.section}>
            ...
            <ScrollView
              ...
              contentContainerStyle={styles.ttlScroll}
            >
                ...
                return (
                  ...
                  >
                    <Text
                      style={[
                        styles.ttlBtnText,
                        isActive && styles.ttlBtnTextActive,
                      ]}
                    >
                      {opt}
                    </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.locationSelectors}>
              <TouchableOpacity
                style={[
                  ...
                  !useWarehouse && styles.locationTypeBtnActive,
                ]}
              ...
              >
                <MaterialIcons
                  name="home"
                  size={20}
                  color={!useWarehouse ? "#fff" : "#64748b"}
                />
                <Text
                  style={[
                    styles.locationTypeText,
                    !useWarehouse && styles.locationTypeTextActive,
                  ]}
                >
                  Minha Casa
                </Text>
            ...
            {useWarehouse ? (
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.warehouseName}>
                    {warehouses.find((w) => w.id === selectedWarehouseId)
                      ?.name || "Selecionar Galpão"}
                  </Text>
                  <Text style={styles.warehouseAddr}>
                    {warehouses.find((w) => w.id === selectedWarehouseId)
                      ?.address || "Toque para escolher"}
                  </Text>
                </View>
                <MaterialIcons
              ...
              <View style={styles.addressSection}>
                <AddressForm onChange={(addr) => setStructuredAddress(addr)} />
                      ...
                      onPress={async () => {
                        if (
                          ...
                          const coords = await geocodeAddress(
                            structuredAddress as StructuredAddress,
                          );
                          if (coords)
                            setLocation({
                          ...
                          Alert.alert(
                            "Preencha o endereço",
                            "Preencha rua, cidade e UF antes de buscar no mapa.",
                          );
                        }
                      }}
                    >
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <Text style={styles.modalSubtitle}>
                  Encontramos irmãos que estão precisando de itens desta
                  categoria. Deseja doar diretamente para um deles?
                </Text>
                    ...
                    <View
                      ...
                      style={[
                        ...
                        selectedRequest?.id === req.id &&
                          styles.matchItemActive,
                      ]}
                    >
                      <View style={styles.matchInfo}>
                        <Text style={styles.matchTitle}>{req.title}</Text>
                        <Text style={styles.matchUser}>
                          Pedido por: {req.requester?.name || "Comunidade"}
                        </Text>
                        <Text style={styles.matchHint}>
                          Dica: Após reservar, o interessado verá sua
                          localização e poderá entrar em contato.
                        </Text>
                      </View>
                      <TouchableOpacity
                ...
                <View style={styles.matchFooter}>
                  <TouchableOpacity
                    style={[
                      ...
                      !selectedRequest && styles.disabledBtn,
                    ]}
                    disabled={!selectedRequest}
                    onPress={() => setShowMatchModal(false)}
                  >
                    <Text style={styles.confirmMatchText}>
                      Reservar para este Pedido
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => {
                  ...
                  >
                    <Text style={styles.skipMatchText}>
                      Postar na Vitrine Geral
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
