...
export default function LoginScreen() {
  ...
  const getFriendlyAuthError = (message: string) => {
    ...
    if (
      ...
      return "Falha de conexao com o servidor. Verifique internet e configuracao do app.";
    }
    ...
    if (
      ...
      return "Configuracao do Supabase invalida neste ambiente.";
    }
        ...
        >
          ...
          <View style={styles.headerArea}>
            ...
            <View style={styles.logoContainer}>
              <Image
                source={{
                  uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuCUdaGw9gVyxbMAgm9soEM2aXfMhwUpn1X39kIyWC7QIOQrNLk_yvmhK34G9i3vKwi6a7BfS4di5jHVAsQgrXsKecn-fWHfb3y23SoBUQdzAXn579XdDrquW_092sJ-ih77V5HQuqIK0v26nnIrj3sFPW2OFM8g1tqAsjCUXYb0ue6qYnrG05gRvEiliQlm0aSHnfJphVVSsaSqeoKek2gLcoj_eRwsxhev4iobENQZlJErEFMuNZhDnrE-y6khyaEJ5jxotyv5ayM",
                }}
                style={styles.logo}
              />
            </View>
            ...
            <Text style={styles.subtitle}>
              Acesse sua conta para realizar sua contribuição
            </Text>
          </View>
